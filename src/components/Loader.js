  ...
  <LoaderSVGWrapper>
    ...
    >
      <path
        ...
        strokeWidth="1.4"
        strokeMiterlimit={10}
        d="M102,64.6c0,0-5.1-1.9-7.9-2.1C91,62.2,87.2,62,87.2,62c-2.3-0.3-3.7-0.7-4.5-0.9c0-0.4,0.1-0.8,0.1-1.2
	...
	c0.5-0.2,0-0.2,0-0.2C104.2,65.1,103.5,65,102,64.6z"
      ...
      <g id="sun_eyes__x26__mouth">
        <g>
          <path
            fill="#6C757C"
            d="M67.1,55.7c0,0.8-0.7,1.4-1.5,1.4c-0.8,0-1.4-0.7-1.4-1.5l0-0.2c-0.1-0.2-0.8-0.4-1.7,0.2
          ...
          <path
            fill="#6C757C"
            d="M71.2,60c-0.3,0.7-2.8,1-3.3,0c-0.2-0.4-0.4-1.3-0.1-1.1c0.6,0.3,2.6,0.1,3,0c0.3-0.1,0.1-0.6,0.3-0.5
				C71.4,58.4,71.4,59.3,71.2,60"
          />
          <path
            fill="#6C757C"
            d="M77.2,55.9c-0.6-0.5-1.5-0.8-1.8-0.5l0,0.1c0.1,0.8-0.5,1.5-1.3,1.5c-0.8,0.1-1.5-0.5-1.5-1.3v-0.1
      ...
      <g id="shield">
        ...
        <g>
          <path
            fill="none"
            d="M46.4,82.8c-1.8,0.1-3.6,0.8-4.7,0.6v12.3c0,0,0.7,0.5,2.5,0c2.4-0.7,3.4,0.1,3.4,0.1V83.3
			C47.7,83.3,47.4,82.8,46.4,82.8z"
          />
          <path
            fill="none"
            d="M93.1,82.8c-1,0-1.3,0.5-1.3,0.5v12.4c0,0,1.1-0.7,3.5-0.1c1.8,0.5,2.5,0,2.5,0V83.4
			C96.7,83.6,94.9,82.8,93.1,82.8z"
          />
          <path
            fill="none"
            d="M105.7,77.3H76.2v26.8h29.5V77.3z M101.3,98.6h-8.5v1.1h-3.5v-1.1h-8.5V84.3h1.8v-2.6
			c1.8,0.4,4.8-0.6,6.2-0.6c1.5,0,2.2,0.6,2.2,0.6s0.8-0.6,2.2-0.6c1.3,0,4.3,1,6.2,0.6v2.6h1.8V98.6z"
          />
          <path
            fill="none"
            d="M63.3,77.3H33.8v26.8h29.5V77.3z M58.8,98.6h-8.5v1.1h-3.5v-1.1h-8.5V84.3h1.8v-2.6c1.8,0.4,4.8-0.6,6.2-0.6
			c1.5,0,2.2,0.6,2.2,0.6s0.8-0.6,2.2-0.6c1.3,0,4.3,1,6.2,0.6v2.6h1.8V98.6z"
          />
          <path
            fill="none"
            d="M50.8,82.8c-1,0-1.3,0.5-1.3,0.5v12.4c0,0,1.1-0.7,3.5-0.1c1.8,0.5,2.5,0,2.5,0V83.4
			C54.5,83.6,52.7,82.8,50.8,82.8z"
          />
          <path
            fill="none"
            d="M47.7,134.3v-12.4c0,0-0.3-0.6-1.3-0.5c-1.8,0.1-3.6,0.8-4.7,0.6v12.3c0,0,0.7,0.5,2.5,0
			C46.6,133.6,47.7,134.3,47.7,134.3z"
          />
          <path
            fill="none"
            d="M53,134.3c1.8,0.5,2.5,0,2.5,0V122c-1.1,0.2-2.9-0.5-4.7-0.6c-1,0-1.3,0.5-1.3,0.5v12.4
			C49.6,134.3,50.6,133.6,53,134.3z"
          />
          <path
            fill="none"
            d="M38.4,135.7v-12.8h1.8v-2.6c1.8,0.4,4.8-0.6,6.2-0.6c1.5,0,2.2,0.6,2.2,0.6s0.8-0.6,2.2-0.6
          ...
          <polygon
            fill="none"
            points="64.9,152.4 69.8,153.7 74.7,152.4 74.7,114.4 105.7,114.4 105.7,105.7 74.7,105.7 74.7,77.3
			64.9,77.3 64.9,105.7 33.8,105.7 33.8,114.4 64.9,114.4 		"
          />
          <path
            fill="none"
            d="M88.7,82.8c-1.8,0.1-3.6,0.8-4.7,0.6v12.3c0,0,0.7,0.5,2.5,0c2.4-0.7,3.4,0.1,3.4,0.1V83.3
			C90,83.3,89.7,82.8,88.7,82.8z"
          />
          <path
            fill="none"
            d="M76.2,116.1V152c7.4-2.2,14.8-5,19.8-9.6c1.8-1.6,3.2-3.3,4.5-5.1h-7.6v1.1h-3.5v-1.1h-8.5v-14.3h1.8v-2.6
			c1.8,0.4,4.8-0.6,6.2-0.6c1.5,0,2.2,0.6,2.2,0.6s0.8-0.6,2.2-0.6c1.3,0,4.3,1,6.2,0.6v2.6h1.8v12.9c2.7-4.7,4-10.5,4.4-18.5
			l-0.1-1.2H76.2z"
          />
          <path
            fill="none"
            d="M84.2,122v12.3c0,0,0.7,0.5,2.5,0c2.4-0.7,3.5,0.1,3.5,0.1v-12.4c0,0-0.3-0.6-1.3-0.5
			C87.1,121.4,85.3,122.2,84.2,122z"
          />
          <path
            fill="none"
            d="M92.1,121.9v12.4c0,0,1.1-0.7,3.4-0.1c1.8,0.5,2.5,0,2.5,0V122c-1.1,0.2-2.9-0.5-4.7-0.6
			C92.3,121.3,92.1,121.9,92.1,121.9z"
          />
          <path
            fill="#6C757C"
            d="M32,115.1c0,13.1,3.3,22.2,10.3,28.5c6.9,6.3,17.4,9.5,27.5,11.9c10.5-2.5,20.5-5.5,27.5-11.9
          ...
          <path
            fill="#6C757C"
            d="M57,81.7c-1.8,0.4-4.8-0.6-6.2-0.6c-1.5,0-2.2,0.6-2.2,0.6s-0.8-0.6-2.2-0.6c-1.3,0-4.3,1-6.2,0.6v2.6h-1.8
          ...
          <path
            fill="#6C757C"
            d="M99.5,81.7c-1.8,0.4-4.8-0.6-6.2-0.6c-1.5,0-2.2,0.6-2.2,0.6s-0.8-0.6-2.2-0.6c-1.3,0-4.3,1-6.2,0.6v2.6h-1.8
      ...
      <g id="clouds_of_ignorance">
        <path
          ...
          strokeWidth="1.4"
          strokeMiterlimit={10}
          d="M41,40.3c0,0,0.6-4.1,5.8-4.6c0,0,0.4-8.5,10.9-4.5c0,0,0,0,0,0c0,0,2.2-9.3,12.4-3.8c0,0,8.3-5.3,13.7,4.3
      ...
      <g id="decor">
        <path
          ...
          strokeLinejoin="round"
          strokeMiterlimit={10}
          d="M43.4,62.8c0,0-5.9-3.7-9.7,0.4c0,0-1.6,1.8-0.3,4.3c1.5,2.8,4.9,2.7,6.9,0.9c0,0,1.8,2.8,6.5,0.1
