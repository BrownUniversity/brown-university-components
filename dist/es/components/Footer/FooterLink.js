...
var FooterLink = function FooterLink(_ref) {
  ...
  return React.createElement(Tag, _extends({
    href: href
  }, restProps), React.createElement(Label, null, children), React.createElement(IconsWrapper, null, React.createElement(DefaultIconWrapper, null, React.createElement(DefaultIcon, null)), React.createElement(ActionIconWrapper, null, React.createElement(ActionIcon, null))));
};
