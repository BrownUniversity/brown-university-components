...
var addressItemCSS = css(["", " display:block;padding-left:25px;position:relative;", ";"], unstyledLinkCSS, media.lg(_templateObject()));
var addressIconCSS = css(["fill:rgba(255,255,255,0.2);left:0;position:absolute;top:0;transform-origin:left top;", ";"], media.xl(_templateObject2()));
...
})(["display:flex;flex-wrap:wrap;margin-left:auto;margin-right:auto;min-width:320px;width:calc(100% - 40px);", ";", ";", ";", ";", ";"], media.sm(_templateObject3(), breakpoints.sm - 20), media.md(_templateObject4(), breakpoints.md - 20), media.lg(_templateObject5(), breakpoints.lg - 20), media.xl(_templateObject6(), breakpoints.xl - 20), media.xxl(_templateObject7(), breakpoints.xxl - 20));
...
})(["padding:40px 0 50px;", ";", ";"], media.md(_templateObject8()), media.lg(_templateObject9()));
var RibbonInner = styled.div.withConfig({
  displayName: "Footer__RibbonInner",
  componentId: "sc-1s3f2bx-4"
})(["display:flex;flex-direction:column;width:100%;", ";"], media.lg(_templateObject10()));
var RibbonGroup = styled.div.withConfig({
  displayName: "Footer__RibbonGroup",
  componentId: "sc-1s3f2bx-5"
})(["", ";"], media.lg(_templateObject11(), ribbonAsideWidth));
var AddressWrapper = styled.div.withConfig({
  displayName: "Footer__AddressWrapper",
  componentId: "sc-1s3f2bx-6"
})(["margin-bottom:16px;", ";"], media.xl(_templateObject12()));
var AddressName = styled.span.withConfig({
  displayName: "Footer__AddressName",
  componentId: "sc-1s3f2bx-7"
})(["color:", ";display:block;font-family:", ";font-size:", ";font-weight:400;letter-spacing:", ";margin-bottom:26px;text-transform:uppercase;", ";", ";"], colors.taupe, typography.sans, getRems(11), getRems(1.25), media.md(_templateObject13(), getRems(13), getRems(1.5)), media.lg(_templateObject14()));
...
})(["", " margin-bottom:14px;", ";"], addressItemCSS, media.lg(_templateObject15()));
...
})(["color:", ";font-family:", ";font-weight:400;line-height:1.3125;", ";", ";"], colors.white, typography.serif, media.md(_templateObject16(), getRems(20)), media.xl(_templateObject17(), getRems(24)));
...
})(["display:inline-block;vertical-align:middle;", ";"], media.md(_templateObject34()));
...
})(["", " box-shadow:inset 0 0 0 1px transparent;display:flex;justify-content:center;padding:17px 8px;position:relative;text-align:center;transition:color 0.25s;", ";"], unstyledLinkCSS, media.md(_templateObject35()));
...
})(["border-top:1px solid rgba(183,176,156,0.2);color:", ";font-family:", ";font-size:", ";font-weight:400;margin:0 -10px;padding-top:20px;", ";"], colors.taupe, typography.serif, getRems(14), media.md(_templateObject36(), getRems(20)));
/*
  outer Footer component
*/

var Footer = function Footer() {
  return React.createElement(Wrapper, null, React.createElement(RibbonOuter, null, React.createElement(Margins, null, React.createElement(RibbonInner, null, React.createElement(RibbonGroup, null, React.createElement(AddressWrapper, null, React.createElement(AddressName, null, "Brown University"), React.createElement(AddressItems, null, React.createElement(AddressBaseItem, {
    ...
    target: "_blank",
    rel: "noopener noreferrer"
  }, React.createElement(AddressBaseIcon, null), " ", React.createElement(AddressInfo, null, "Providence, RI 02912")), React.createElement(AddressPhoneItem, {
    href: "tel:4018631000"
  }, React.createElement(AddressPhoneIcon, null), " ", React.createElement(AddressInfo, null, "401-863-1000")))), React.createElement(QuickNavWrapper, null, React.createElement(NavigationHeader, null, "Quick Navigation"), React.createElement(QuickNavList, {
    "aria-label": "Quick Navigation"
  }, React.createElement(QuickNavListItem, null, React.createElement(PaddedFooterLink, {
    href: "https://www.brown.edu/about/visit"
  }, "Visit Brown")), React.createElement(QuickNavListItem, null, React.createElement(PaddedFooterLink, {
    href: "https://www.brown.edu/Facilities/Facilities_Management/maps/#building/"
  }, "Campus Map")), React.createElement(QuickNavListItem, null, React.createElement(PaddedFooterLink, {
    href: "https://www.brown.edu/a-z"
  }, "A to Z")), React.createElement(QuickNavListItem, null, React.createElement(PaddedFooterLink, {
    href: "https://www.brown.edu/about/contact-us"
  }, "Contact Us")))), React.createElement(FooterNavWrapper, null, React.createElement(NavigationHeader, null, "Footer Navigation"), React.createElement(FooterNavList, {
    "aria-label": "Footer Navigation"
  }, React.createElement(FooterNavListItem, null, React.createElement(PaddedFooterLink, {
    href: "https://www.brown.edu/news"
  }, "News")), React.createElement(FooterNavListItem, null, React.createElement(PaddedFooterLink, {
    href: "https://events.brown.edu/"
  }, "Events")), React.createElement(FooterNavListItem, null, React.createElement(PaddedFooterLink, {
    href: "https://www.brown.edu/about/administration/public-safety/"
  }, "Campus Safety")), React.createElement(FooterNavListItem, null, React.createElement(PaddedFooterLink, {
    href: "https://www.brown.edu/website-accessibility"
  }, "Accessibility")), React.createElement(FooterNavListItem, null, React.createElement(PaddedFooterLink, {
    href: "https://www.brown.edu/about/administration/human-resources/employment-performance-development/jobsbrown"
  }, "Careers At Brown"))))), React.createElement(RibbonAside, null, React.createElement(GiveWrapper, null, React.createElement(GiveLogo, {
    src: giveLogoSrc,
    alt: "Brown Together"
  }), React.createElement(GiveCaption, null, "The campaign for building on distinction"), React.createElement(FooterLink, {
    href: "https://giving.brown.edu/"
  }, "Give To Brown")))))), React.createElement(SoleOuter, null, React.createElement(Margins, null, React.createElement(SoleInner, null, React.createElement(SocialNavWrapper, null, React.createElement(NavigationHeader, null, "Social Navigation"), React.createElement(SocialNavList, {
    "aria-label": "Social Navigation"
  }, React.createElement(SocialNavListItem, null, React.createElement(SocialNavLink, {
    href: "https://www.facebook.com/BrownUniversity"
  }, React.createElement(SocialFacebookIcon, null), React.createElement(SocialIconLabel, null, "Facebook"))), React.createElement(SocialNavListItem, null, React.createElement(SocialNavLink, {
    href: "https://instagram.com/brownu"
  }, React.createElement(SocialInstagramIcon, null), React.createElement(SocialIconLabel, null, "Instagram"))), React.createElement(SocialNavListItem, null, React.createElement(SocialNavLink, {
    href: "https://www.linkedin.com/edu/school?id=19348"
  }, React.createElement(SocialLinkedInIcon, null), React.createElement(SocialIconLabel, null, "LinkedIn"))), React.createElement(SocialNavListItem, null, React.createElement(SocialNavLink, {
    href: "https://www.snapchat.com/add/brown-u"
  }, React.createElement(SocialSnapchatIcon, null), React.createElement(SocialIconLabel, null, "Snapchat"))), React.createElement(SocialNavListItem, null, React.createElement(SocialNavLink, {
    href: "https://twitter.com/BrownUniversity"
  }, React.createElement(SocialTwitterIcon, null), React.createElement(SocialIconLabel, null, "Twitter"))), React.createElement(SocialNavListItem, null, React.createElement(SocialNavLink, {
    href: "https://www.youtube.com/brownuniversity"
  }, React.createElement(SocialYouTubeIcon, null), React.createElement(SocialIconLabel, null, "YouTube"))))), React.createElement(Copyright, null, "\xA9 Brown University")))));
};
