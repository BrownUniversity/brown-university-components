...
```
  // npm
  npm i git+https://bitbucket.brown.edu/scm/react/brown-university-components.git#semver:^0.8
  // yarn
  yarn add git+https://bitbucket.brown.edu/scm/react/brown-university-components.git#^0.8
```
...
1. Bump version in `README.md` install instructions (for major and minor version bumps only)
1. Update `CHANGELOG.md`
1. `npm run build`
1. Commit changes
1. Tag new version
1. Push master and tags to all remotes
