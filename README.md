...
```
  // npm
  npm i -D eslint git+https://bitbucket.brown.edu/scm/react/brown-university-components.git#semver:^0.8
  // yarn
  yarn add -D eslint git+https://bitbucket.brown.edu/scm/react/brown-university-components.git#^0.8
```
