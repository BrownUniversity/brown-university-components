...
```sh
// npm
npm i git+https://bitbucket.brown.edu/scm/react/brown-university-components.git#semver:^1.2

// yarn
yarn add git+https://bitbucket.brown.edu/scm/react/brown-university-components.git#^1.2
```
